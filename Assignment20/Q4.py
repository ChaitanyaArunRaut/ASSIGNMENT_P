# Create Thread Small, Capital and Digit
# all threads should accept a string as input
# Small - count and display number of lowercase char
# Capital - count and display uppercase character
# Digit - count and Dispsy Number of numeric digit
import threading
import os
